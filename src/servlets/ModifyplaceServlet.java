...
public class ModifyplaceServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			String vid = session.getAttribute("vplace").toString();
			...
			//设置存到数据库中的路径
			String vimage=url+filename+"."+ext;
			boolean cmark;
			
			String sql="update place set vid='"+vid+
					"',vname='"+vname+"',vplace='"+vplace+
					"',vfamous='"+vfamous +"',vintro='"+vintro+
					"',vimage='"+vimage+"'where vid='"+vid+"'";
			...
			if(cmark){
				...
				info="添加成功！";
				forward="/jsp/admin/jingdian/mdjingdian.jsp";
