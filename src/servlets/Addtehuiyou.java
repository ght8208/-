...
public class Addtehuiyou extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			int cmark=0;
			String sql="insert into tehuiyou(thid,thname,thplace,thpingfen,thprice,thintro,thimage) values (?,?,?,?,?,?,?)";
			DB db=new DB();
			conn=db.createConn();
			...
			pstmt.setString(3,thplace);
			pstmt.setString(4,thpingfen);
			pstmt.setString(5,thprice);
			pstmt.setString(6,thintro);
			pstmt.setString(7,thimage);
