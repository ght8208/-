...
public class Modifytiezi extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			String lttzid = session.getAttribute("lttiezi").toString();
			...
			boolean cmark;
			boolean cmark1;
			String sql="update lttiezi set lttzid='"+lttzid+
					"',lttzname='"+lttzname+"',lttzjing='"+lttzjing+
					"',lttzintro='"+lttzintro +"',lttzimage='"
					+lttzimage+"'where lttzid='"+lttzid+"'";
			cmark= db.executeUpdate(sql);
			String sql1="update lttiezi1 set lttzid='"+lttzid+
					"',ltbkid='"+ltbkid+"'where lttzid='"+lttzid+"'";
			...
			if(cmark&&cmark1){
				...
				info="添加成功！";
				forward="/jsp/admin/luntan/tiezi/showtiezi.jsp";
