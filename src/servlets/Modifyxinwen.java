...
public class Modifyxinwen extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			String xid = session.getAttribute("xinwen").toString();
			...
			String sql="update xinwen set xid='"+xid+
					"',biaoti='"+biaoti+"',xdate='"+xdate+
					"',xintro='"+xintro +"',xtag='"+xtag+
					"'where xid='"+xid+"'";
			...
			if(cmark){
				...
				info="添加成功！";
				forward="/jsp/admin/xinwen/showxinwen.jsp";
