...
public class Modifybankuai extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public Modifybankuai() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			String ltbkname =req.getParameter("ltbkname");
			String ltbkintro =req.getParameter("ltbkintro");
			String ltbkid = session.getAttribute("ltbankuai").toString();
			...
			//设置存到数据库中的路径
			String ltbkimage=url+filename+"."+ext;
			boolean cmark;
			
			String sql="update ltbankuai set ltbkid='"+ltbkid+
					"',ltbkname='"+ltbkname+
					"',ltbkintro='"+ltbkintro+"',ltbkimage='"+ltbkimage
					+"'where ltbkid='"+ltbkid+"'";
			...
			if(cmark){
				...
				info="添加成功！";
				forward="/jsp/admin/luntan/bankuai/showbankuai.jsp";
