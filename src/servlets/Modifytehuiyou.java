...
public class Modifytehuiyou extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public Modifytehuiyou() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			String thname =req.getParameter("thname");
			String thplace =req.getParameter("thplace");
			String thpingfen = req.getParameter ("thpingfen");
			String thprice =req.getParameter("thprice");
			String thintro = req.getParameter ("thintro");
			String thid = session.getAttribute("tehuiyou").toString();
			...
			//设置存到数据库中的路径
			String thimage=url+filename+"."+ext;
			boolean cmark;
			
			String sql="update tehuiyou set thid='"+thid+
					"',thname='"+thname+"',thplace='"+thplace+
					"',thpingfen='"+thpingfen +"',thprice='"+thprice+
					"',thintro='"+thintro+"',thimage='"+thimage
					+"'where thid='"+thid+"'";
			...
			if(cmark){
				...
				info="添加成功！";
				forward="/jsp/admin/tehuiyou/showtehuiyou.jsp";
