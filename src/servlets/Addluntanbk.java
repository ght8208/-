...
public class Addluntanbk extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			int cmark=0;
			String sql="insert into ltbankuai(ltbkid,ltbkname,ltbkintro,ltbkimage) values (?,?,?,?)";
			DB db=new DB();
			conn=db.createConn();
			conn.setAutoCommit(true);
			pstmt=conn.prepareStatement(sql);
			pstmt.setString(1,ltbkid);
			pstmt.setString(2,ltbkname);
			pstmt.setString(3,ltbkintro);
			pstmt.setString(4,ltbkimage);
