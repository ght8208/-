...
public class ModifyGUserServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public ModifyGUserServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int userhuiyuan=Integer.parseInt(request.getParameter("userhuiyuan"));
		...
		newsql.append("',huiyuan=");
		newsql.append(userhuiyuan);
		...
		if(a)
		{
			...
			{
				response.sendRedirect("/wenq/jsp/admin/user/MDeleteGuser.jsp");
			}
			else
			{
				response.sendRedirect("/wenq/jsp/visitors/ownfunction.jsp");
			}
