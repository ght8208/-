...
<html>
  ...
  <body>
	...
	<!-- 当前位置区 -->
	<div class="position">
	您所在的位置：<a href="/main.jsp">首页</a>&gt;<span>杭州专区</span>&gt;<span>景区位置</span>
 	</div>
...
<!-- 	创建地图 -->
    ...
    function createMap(){
        ...
        var point = new BMap.Point(120.157282,30.252424);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"西湖风景区",content:"西湖",point:"120.149413|30.257353",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ];
    //创建marker
    function addMarker(){
