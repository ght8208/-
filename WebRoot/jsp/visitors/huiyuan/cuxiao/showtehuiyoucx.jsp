...
<%@include file="/jsp/visitors/huiyuan/cuxiao/tehuiyoupage.jsp" %>
<%
...
<html>
  ...
  <table border="0">
     ...
     {
       String watchurl="/wenq/jsp/admin/dingdan/buyinfo.jsp?thid="+rs.getString(1);
	  %>
<tr>
			<td>
				<div class="tdleft">
			...
			<td>
				<div class="tdright">
					...
					<div class="tdright-bottom">
						<div class="intro">
							介绍:<br/><br/><%=rs.getString(6)%>
						</div>
					</div>
					<div class="tdbottom">
					<b class="yuanjia">原价：￥<%=rs.getString(5)%></b>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<b class="cuxiao">促销价：￥<%=rs.getString(8)%></b>
					</div>
				</div>
			</td>
	...
	<table class="tablelist">
       ...
       {
      %>
			<td width=150><a href="/wenq/jsp/visitors/huiyuan/cuxiao/showtehuiyoucx.jsp?ToPage=<%=1 %>">第一页</a></td>
			<td width=150><a href="/wenq/jsp/visitors/huiyuan/cuxiao/showtehuiyoucx.jsp?ToPage=<%=ShowPage-1 %>">上一页</a>
			</td>
			<% 
       }
       ...
       %>
			<td width=150>
				...
				<a href="/wenq/jsp/visitors/huiyuan/cuxiao/showtehuiyoucx.jsp?ToPage=<%=ShowPage + 1%>">
					下一页 </a>
			</td>
			<td width=150><a href="/wenq/jsp/visitors/huiyuan/cuxiao/showtehuiyoucx.jsp?ToPage=<%=PageCount %>">最后一页</a>
			</td>
			<%
         }
         %>
		...
		<tr>
			...
			<td colspan="4" align="center">
				<form action="/wenq/jsp/visitors/huiyuan/cuxiao/showtehuiyoucx.jsp" method="post" name="form1">
