...
<%@include file="/jsp/visitors/huiyuan/duihuan/tehuiyoupage.jsp" %>
<%
...
<tr>
			...
			<td>
				<div class="tdright">
					...
					<div class="tdbottom">
					<b class="yuanjia">积分回扣</b>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<b class="cuxiao">积分抵扣：<%=rs.getString(9)%>分</b>
					</div>
				</div>
			</td>
	...
	<table class="tablelist">
       ...
       {
      %>
			<td width=150><a href="/wenq/jsp/visitors/huiyuan/duihuan/showtehuiyoudh.jsp?ToPage=<%=1 %>">第一页</a></td>
			<td width=150><a href="/wenq/jsp/visitors/huiyuan/duihuan/showtehuiyoudh.jsp?ToPage=<%=ShowPage-1 %>">上一页</a>
			</td>
			<% 
       }
       ...
       %>
			<td width=150>
				...
				<a href="/wenq/jsp/visitors/huiyuan/duihuan/showtehuiyoudh.jsp?ToPage=<%=ShowPage + 1%>">
					下一页 </a>
			</td>
			<td width=150><a href="/wenq/jsp/visitors/huiyuan/duihuan/showtehuiyoudh.jsp?ToPage=<%=PageCount %>">最后一页</a>
			</td>
			<%
         }
         %>
		...
		页,共<%=PageCount%>页
			...
			<td colspan="4" align="center">
				<form action="/wenq/jsp/visitors/huiyuan/duihuan/showtehuiyoudh.jsp" method="post" name="form1">
