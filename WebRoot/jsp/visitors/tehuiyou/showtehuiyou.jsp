...
<%@include file="/jsp/visitors/tehuiyou/tehuiyoupage.jsp" %>
<%
...
<tr>
	...
	<table class="tablelist">
       ...
       {
      %>
			<td width=150><a href="/wenq/jsp/visitors/tehuiyou/showtehuiyou.jsp?ToPage=<%=1 %>">第一页</a></td>
			<td width=150><a href="/wenq/jsp/visitors/tehuiyou/showtehuiyou.jsp?ToPage=<%=ShowPage-1 %>">上一页</a>
			</td>
			<% 
       }
       ...
       %>
			<td width=150>
				...
				<a href="/wenq/jsp/visitors/tehuiyou/showtehuiyou.jsp?ToPage=<%=ShowPage + 1%>">
					下一页 </a>
			</td>
			<td width=150><a href="/wenq/jsp/visitors/tehuiyou/showtehuiyou.jsp?ToPage=<%=PageCount %>">最后一页</a>
			</td>
			<%
         }
         %>
		...
		<tr>
			...
			<td colspan="4" align="center">
				<form action="/wenq/jsp/visitors/tehuiyou/showtehuiyou.jsp" method="post" name="form1">
