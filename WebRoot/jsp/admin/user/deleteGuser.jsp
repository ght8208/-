...
<html>
  ...
  <body>
   <%
   DB db=new DB();
String sql="delete from visitors where id="+request.getParameter("id") ;
...
if(i){
	...
	//级联删除 
	*/
	session.setAttribute("deleteuser", "删除成功！");
}else{
	session.setAttribute("deleteuser", "删除失败！");
}
...
if(session.getAttribute("deleteuser")!=null)
    ...
    String content="5;url=/wenq/jsp/admin/user/MDeleteGuser.jsp";
