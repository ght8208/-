  ...
  <div class="place">
   ...
   <thead>
    ...
    <%
    	...
    	{
    		/* modifyurl把用户的id传了过来 */
    		String modifyurl = "/wenq/jsp/admin/user/modifyUser.jsp?id="+rs.getInt(1);
    		String deleteurl = "/wenq/jsp/admin/user/deleteuser.jsp?id="+rs.getInt(1);
    %>
