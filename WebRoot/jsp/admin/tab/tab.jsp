...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="css/admin/select.css">
	<script language="JavaScript" src="js/jquery-1.11.1.js"></script>
	<script type="text/javascript" src="js/admin/tab/jquery.idTabs.min.js"></script>
	<script type="text/javascript" src="js/admin/tab/select-ui.min.js"></script>
	<script type="text/javascript" src="js/admin/tab/kindeditor.js"></script>
  ...
  <body>
    ...
    <table class="tablelist">
        ...
        <th>编号<i class="sort"><img src="/wenq/images/admin/tab/px.gif" /></i></th>
        <th>标题</th>
        <th>用户</th>
        <th>籍贯</th>
        <th>发布时间</th>
