...
<html>
  ...
  <body>
   <%
   DB db=new DB();
String sql="delete from tehuiyou where thid="+request.getParameter("thid") ;
...
if(i){
	...
	//级联删除 
	*/
	session.setAttribute("deletetehuiyou", "删除成功！");
}else{
	session.setAttribute("deletetehuiyou", "删除失败！");
}

if(session.getAttribute("deletetehuiyou")!=null)
    {
    
    //out.println(session.getAttribute("deleteuser"));
    session.setAttribute("deletetehuiyou",null);
    
    String content="5;url=/wenq/jsp/admin/tehuiyou/showtehuiyou.jsp";
