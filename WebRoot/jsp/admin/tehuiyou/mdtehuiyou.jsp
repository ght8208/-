...
$(function(){	
  ...
  <ul class="imglist">
    ...
    <li>
	    ...
	    <h2>特惠游名称：<%=rs.getString(2)%></h2>
	    <h2>所处位置：<%=rs.getString(3)%></h2>
	    <h2>特惠游评分：<%=rs.getString(4)%></h2>
		<p>
	...
	<table class="tablelist">
       ...
       {
      %>
			<td width=150><a href="/wenq/jsp/admin/tehuiyou/mdtehuiyou.jsp?ToPage=<%=1 %>">第一页</a></td>
			<td width=150><a href="/wenq/jsp/admin/tehuiyou/mdtehuiyou.jsp?ToPage=<%=ShowPage-1 %>">上一页</a>
			</td>
			<% 
       }
       ...
       %>
			...
			<td width=150><a href="/wenq/jsp/admin/tehuiyou/mdtehuiyou.jsp?ToPage=<%=PageCount %>">最后一页</a>
			</td>
			<%
         }
         %>
