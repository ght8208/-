...
<html>
  ...
  <body>
   <%
   DB db=new DB();
String sql="delete from jiudian where jid="+request.getParameter("jid") ;
...
if(i){
	...
	//级联删除 
	*/
	session.setAttribute("deletejiudian", "删除成功！");
}else{
	session.setAttribute("deletejiudian", "删除失败！");
}

if(session.getAttribute("deletejiudian")!=null)
    {
    
    //out.println(session.getAttribute("deleteuser"));
    session.setAttribute("deletejiudian",null);
    
    String content="5;url=/wenq/jsp/admin/jiudian/showjiudian.jsp";
