  ...
  <th>操作：</th>
   ...
   <tbody>
	...
	<table class="tablelist">
       ...
       {
      %>
			<td width=150><a href="/wenq/jsp/admin/jiudian/mdjiudian.jsp?ToPage=<%=1 %>">第一页</a></td>
			<td width=150><a href="/wenq/jsp/admin/jiudian/mdjiudian.jsp?ToPage=<%=ShowPage-1 %>">上一页</a>
			</td>
			<% 
       }
       ...
       %>
			...
			<td width=150><a href="/wenq/jsp/admin/jiudian/mdjiudian.jsp?ToPage=<%=PageCount %>">最后一页</a>
			</td>
			<%
         }
         %>
