...
<style type="text/css">
  ...
  <thead>
  <tr>
  <th>酒店编号<i class="sort"><img src="/wenq/images/admin/tab/px.gif" /></i></th>
  <th>酒店名称</th>
  <th>酒店所处位置：</th>
  <th>酒店评分：</th>
  <th>酒店介绍：</th>
  ...
  <tbody>
	...
	<table class="tablelist">
       ...
       {
      %>
			<td width=150><a href="/wenq/jsp/admin/jiudian/showjiudian.jsp?ToPage=<%=1 %>">第一页</a></td>
			<td width=150><a href="/wenq/jsp/admin/jiudian/showjiudian.jsp?ToPage=<%=ShowPage-1 %>">上一页</a>
			</td>
			<% 
       }
       ...
       %>
			<td width=150>
				...
				<a href="/wenq/jsp/admin/jiudian/showjiudian.jsp?ToPage=<%=ShowPage + 1%>">
					下一页 </a>
			</td>
			<td width=150><a href="/wenq/jsp/admin/jiudian/showjiudian.jsp?ToPage=<%=PageCount %>">最后一页</a>
			</td>
			<%
         }
         %>
		...
		<tr>
				...
				<form action="/wenq/jsp/admin/jiudian/showjiudian.jsp" method="post" name="form1">
