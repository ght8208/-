...
<html>
  ...
  <body>
   <%
   DB db=new DB();
String sql="delete from ltbankuai where ltbkid="+request.getParameter("ltbkid") ;
...
if(i){
	...
	//级联删除 
	*/
	session.setAttribute("deleteltbankuai", "删除成功！");
}else{
	session.setAttribute("deleteltbankuai", "删除失败！");
}

if(session.getAttribute("deleteltbankuai")!=null)
    {
    
    //out.println(session.getAttribute("deleteuser"));
    session.setAttribute("deleteltbankuai",null);
    
    String content="5;url=/wenq/jsp/admin/luntan/bankuai/showbankuai.jsp";
