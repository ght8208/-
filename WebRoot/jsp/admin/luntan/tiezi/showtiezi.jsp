...
$(document).ready(function(){
  ...
  <tbody>
	...
	<table class="tablelist">
       ...
       {
      %>
			<td width=150><a href="/wenq/jsp/admin/luntan/tiezi/showtiezi.jsp?ToPage=<%=1 %>">第一页</a></td>
			<td width=150><a href="/wenq/jsp/admin/luntan/tiezi/showtiezi.jsp?ToPage=<%=ShowPage-1 %>">上一页</a>
			</td>
			<% 
       }
       ...
       %>
			<td width=150>
				...
				<a href="/wenq/jsp/admin/luntan/tiezi/showtiezi.jsp?ToPage=<%=ShowPage + 1%>">
					下一页 </a>
			</td>
			<td width=150><a href="/wenq/jsp/admin/luntan/tiezi/showtiezi.jsp?ToPage=<%=PageCount %>">最后一页</a>
			</td>
			<%
         }
         %>
		...
		<tr>
				...
				<form action="/wenq/jsp/admin/luntan/tiezi/showtiezi.jsp" method="post" name="form1">
