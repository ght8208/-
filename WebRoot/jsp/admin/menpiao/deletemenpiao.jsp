...
<html>
  ...
  <body>
   <%
   DB db=new DB();
String sql="delete from goods where id="+request.getParameter("id") ;
...
if(i){
	...
	//级联删除 
	*/
	session.setAttribute("deletemenpiao", "删除成功！");
}else{
	session.setAttribute("deletemenpiao", "删除失败！");
}

if(session.getAttribute("deletemenpiao")!=null)
    {
    
    //out.println(session.getAttribute("deleteuser"));
    session.setAttribute("deletemenpiao",null);
    
    String content="5;url=/wenq/jsp/admin/menpiao/mdmenpiao.jsp";
