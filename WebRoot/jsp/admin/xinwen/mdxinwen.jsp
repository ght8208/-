...
$(document).ready(function(){
  ...
  <th>操作：</th>
   ...
   <tbody>
     ...
     {
       String modifyurl="/wenq/jsp/admin/xinwen/modifyxinwen.jsp?xid="+rs.getString(1);
       String deleteurl="/wenq/jsp/admin/xinwen/deletexinwen.jsp?xid="+rs.getString(1);
	...
	<table class="tablelist">
       ...
       {
      %>
			<td width=150><a href="/wenq/jsp/admin/xinwen/mdxinwen.jsp?ToPage=<%=1 %>">第一页</a></td>
			<td width=150><a href="/wenq/jsp/admin/xinwen/mdxinwen.jsp?ToPage=<%=ShowPage-1 %>">上一页</a>
			</td>
			<% 
       }
       ...
       %>
			<td width=150>
				...
				<a href="/wenq/jsp/admin/xinwen/mdxinwen.jsp?ToPage=<%=ShowPage + 1%>">
					下一页 </a>
			</td>
			<td width=150><a href="/wenq/jsp/admin/xinwen/mdxinwen.jsp?ToPage=<%=PageCount %>">最后一页</a>
			</td>
			<%
         }
         %>
		...
		<tr>
			...
			<td colspan="4" align="center">
				<form action="/wenq/jsp/admin/xinwen/mdxinwen.jsp" method="post" name="form1">
