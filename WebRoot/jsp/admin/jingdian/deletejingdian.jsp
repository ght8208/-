...
<html>
  ...
  <body>
   <%
   DB db=new DB();
String sql="delete from place where vid="+request.getParameter("vid") ;
...
if(i){
	...
	//级联删除 
	*/
	session.setAttribute("deleteplace", "删除成功！");
}else{
	session.setAttribute("deleteplace", "删除失败！");
}

if(session.getAttribute("deleteplace")!=null)
    {
    
    //out.println(session.getAttribute("deleteuser"));
    session.setAttribute("deleteplace",null);
    
    String content="5;url=/wenq/jsp/admin/jingdian/showjingdian.jsp";
