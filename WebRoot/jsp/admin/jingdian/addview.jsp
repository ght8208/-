...
<html>
  <head>
   ...
   <body>
    ...
    <form action="AddplaceServlet" method="post"  name="form1" enctype="multipart/form-data">
      <table border="1" class="tablelist">
      
        <tr>
          <td height="40">景点编号：</td>
          <td> <input name="vid" type="text" ></td>
        </tr>
        ...
        <tr>
          ...
          <td> <input name="vplace" type="text"></td>
        </tr>
        
        <tr>
          <td height="40">景点 人气：</td>
          <td> <input name="vfamous" type="text"></td>
        </tr>
        
        <tr>
          <td height="40">景点介绍：</td>
          <td> <textarea name="vintro" cols=40 rows=4></textarea></td>
        </tr>
   <tr>  <td>景点图片：</td>
